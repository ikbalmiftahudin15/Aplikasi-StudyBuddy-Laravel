            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            <label for="jenjang_id" class="form-label">{{ __('Education Level') }}</label>
                        ...
                        <div class="mb-3">
                            <label for="kelas_id" class="form-label">{{ __('Class') }}</label>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        jenjangSelect.addEventListener('change', function () {
            ...
            kelasSelect.innerHTML = '<option value="" selected disabled>Select Class</option>';
